                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            @endphp
                                            <td>
                                                @if($row->field == 'shipping_info'&&$data->shipping_info != null)
                                                    @php
                                                        $shipping_info = json_decode($data->shipping_info,true);
                                                    @endphp
                                                    <ul>
                                                        <li>
                                                            Full Name : {{$shipping_info['fullName']}}
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            Phone Number : {{$shipping_info['phone']}}
                                                        </li>
                                                    </ul>
                                                    @continue
                                                @endif
                                        ...
                                        <td>
                                            @php
                                                $cartItems = \App\Http\Controllers\OrderController::getCartItemsByOrder($data->id)
                                            @endphp
                                            <ul>
                                                @foreach($cartItems as $cartItem)
                                                    ...
                                                    <li>Qty : {{$cartItem->qty}}</li>
                                                    <li>Subtotal : {{$cartItem->subtotal()}}</li>
                                                    <li>Tax : {{$cartItem->tax()}}</li>
                                                    <li>Total : {{$cartItem->total()}}</li>
                                                    <li>Img :</li>
                                                    <img style="max-width: 150px;max-height: 150px;"
                                                         src="{{$cartItem->options->img}}"/>
                                                    <hr>
                                                @endforeach
                                            </ul>
                                        </td>
                                        <td>
                                            <a href="{{route('get-bill',['id'=>$data->id])}}"
