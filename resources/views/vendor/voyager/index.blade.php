...
@section('content')
    <div class="page-content">
        ...
        <div class="statistics-dashbord container-fluid row text-center">
            <div class="col-md-9 m-auto float-none">
                <!-- Website Overview -->
                <div class="overview">
                    ...
                    @php
                        ...
                        $all_cart_items= StatisticController::getCartSellingGeneral();
