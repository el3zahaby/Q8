                    ...
                    <div
                        ...
                        <div class="float-right">
                            ...
                            <div class="fluid-container">
                                <h3 class="font-weight-medium text-right mb-0">{{ model_count('App\User') }}</h3>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
                        <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> including designers </p>
                </div>
            </div>
        </div>
        <a class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
            <div class="card card-statistics">
                <div class="card-body">
                    <div
                        class="d-flex flex-md-column flex-xl-row flex-wrap justify-content-between align-items-md-center justify-content-xl-between">
                        ...
                        <div class="float-right">
                            ...
                            <div class="fluid-container">
                                <h3 class="font-weight-medium text-right mb-0">{{ model_count('App\Order') }}</h3>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
            ...
            <div class="card card-statistics">
                <div class="card-body">
                    <div
                        ...
                        <div class="float-right">
                            <p class="mb-0 text-right">Designs</p>
                            <div class="fluid-container">
                                <h3 class="font-weight-medium text-right mb-0">{{ model_count('App\Design',[['accepting',1]]) }}</h3>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
                        <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> Accepted only </p>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
            <div class="card card-statistics">
                <div class="card-body">
                    <div
                        ...
                        <div class="float-right">
                            <p class="mb-0 text-right">Total Visits</p>
                            <div class="fluid-container">
                                <h3 class="font-weight-medium text-right mb-0">{{ model_count('App\Visit') }}</h3>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h2 class="card-title mb-0">Total profits</h2>
                        {{--                    <div class="wrapper d-flex">--}}
                        {{--                        <div class="d-flex align-items-center mr-3">--}}
                        {{--                            <span class="dot-indicator bg-success"></span>--}}
                        {{--                            <p class="mb-0 ml-2 text-muted">Users visit</p>--}}
                        {{--                        </div>--}}
                        {{--                        <div class="d-flex align-items-center">--}}
                        {{--                            <span class="dot-indicator bg-primary"></span>--}}
                        {{--                            <p class="mb-0 ml-2 text-muted">New Visits</p>--}}
                        {{--                        </div>--}}
                        {{--                    </div>--}}
                    </div>
                    <div class="">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-body">
                                        <div
                                            class="d-flex flex-md-column flex-xl-row flex-wrap justify-content-between align-items-md-center justify-content-xl-between">
                                            <div class="float-left">
                                                <i class="mdi mdi-home-currency-usd text-danger icon-lg"></i>
                                            </div>
                                            <div class="float-right">
                                                <p class="mb-0 text-right">Total profits</p>
                                                <div class="fluid-container">
                                                    <h3 class="font-weight-medium text-right mb-0">{{  $totalFromSeals['total'] }}
                                                        <small>KWD</small></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
                                            <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> including
                                            designers </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card card-statistics">
                                    <div class="card-body">
                                        <div
                                            ...
                                            <div class="float-right">
                                                <p class="mb-0 text-right">Site profits</p>
                                                <div class="fluid-container">
                                                    <h3 class="font-weight-medium text-right mb-0">{{  $siteProfit['total'] }}
                                                        <small>KWD</small></h3>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card card-statistics">
                                    <div class="card-body">
                                        <div
                                            ...
                                            <div class="float-right">
                                                <p class="mb-0 text-right">Designers Profit</p>
                                                <div class="fluid-container">
                                                    <h3 class="font-weight-medium text-right mb-0">{{  $designersProfit['total'] }}
                                                        <small>KWD</small></h3>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h2 class="card-title mb-0">Visits Analysis</h2>
                        <div class="wrapper d-flex">
                            <div class="d-flex align-items-center mr-3">
                                <span class="dot-indicator bg-success"></span>
                                <p class="mb-0 ml-2 text-muted">Users visit</p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="shedule-list d-flex align-items-center justify-content-between mb-3">
                        <h3>{{ \Carbon\Carbon::now()->format('j F Y') }}</h3>
                    ...
                    <div class="event border-bottom py-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="image-grouped ml-auto">
                                <img src="{{ url('dash/assets/images/faces/face10.jpg') }}" alt="profile image">
                                <img src="{{ url('dash/assets/images/faces/face13.jpg') }}" alt="profile image"></div>
                        </div>
                    </div>
                    <div class="event py-3 border-bottom">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="image-grouped ml-auto">
                                <img src="{{ url('dash/assets/images/faces/face20.jpg') }}" alt="profile image">
                                <img src="{{ url('dash/assets/images/faces/face17.jpg') }}" alt="profile image">
                                <img src="{{ url('dash/assets/images/faces/face14.jpg') }}" alt="profile image"></div>
                        </div>
                    </div>
                    <div class="event py-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="image-grouped ml-auto">
                                <img src="{{ url('dash/assets/images/faces/face21.jpg') }}" alt="profile image">
                                <img src="{{ url('dash/assets/images/faces/face16.jpg') }}" alt="profile image"></div>
                        </div>
                    </div>
                </div>
            </div>
...
@push('plugin-scripts')
    {!! Html::script('/dash/assets/plugins/chartjs/chart.min.js') !!}
    {!! Html::script('/dash/assets/plugins/jquery-sparkline/jquery.sparkline.min.js') !!}
@endpush
@push('custom-scripts')
    <script>
        var weekLabel =
            {!! json_encode($sDays) !!}
        var maxVisit =
            {{ (int)($maxVisit + ($maxVisit/2)) }}
        var newVisit = {!! json_encode($newVisit) !!};
        var usersVisit = {!! json_encode($usersVisit) !!};
    </script>
    {!! Html::script('/dash/assets/js/dashboard.js') !!}
@endpush
